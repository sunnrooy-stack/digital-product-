    ...
    <div className="bg-background text-foreground flex min-h-screen w-full">
      ...
      <aside className="w-64 border-r border-border bg-card hidden md:flex flex-col">
        <div className="h-16 flex items-center gap-3 px-6 border-b border-border">
          <img src="/logo.png" alt="Digital Products Logo" className="h-10 w-10 object-cover rounded-xl shadow-sm" />
          <span className="font-extrabold text-xl tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-primary to-cyan-400">
            Admin Control
          </span>
        </div>
        <nav className="flex-1 p-4 space-y-2">
          ...
          <Link href="/tickets" className={`flex items-center justify-between px-3 py-2 rounded-lg font-medium transition-colors ${pathname.includes("/tickets") ? "bg-muted text-foreground" : "text-muted-foreground hover:bg-muted hover:text-foreground"}`}>
